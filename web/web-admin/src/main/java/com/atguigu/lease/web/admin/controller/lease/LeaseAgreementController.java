...
public class LeaseAgreementController {
    ...
    @Operation(summary = "根据用户ID查询租约列表")
    @GetMapping("/listByUserId")
    public Result<List<AgreementVo>> listByUserId(@RequestParam("userId") Long userId) {
        List<AgreementVo> list = service.listByUserId(userId);
